...
Assisted workflow actions: fanfic_init, continuation_import, spinoff_create. After confirmation, InkOS only opens the existing Studio tool; do not claim finished content was generated.
