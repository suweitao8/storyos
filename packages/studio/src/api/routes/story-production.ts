...
export function unifiedScriptRequirements(): string {
  return [
    ...
    "旁白要用口语化、有画面感的讲述语气，像在给观众讲故事。",
    "每条旁白严格控制在 20-60 字。一个镜头一段旁白，一个旁白对应一个分镜。超出的要精简——保留最有信息量的那一句，删掉解释性铺陈。",
    "旁白只做讲述，不要把角色的对话直接写进旁白。如果有对话，用旁白转述：不写「他说：上车吧」，写「他催我上车」。",
    "旁白不要写声音描述（如「啪嗒啪嗒」「嗡鸣声」），声音由画面和配音呈现，旁白只讲故事。",
    "",
    "## 画面与资产标注（关键）",
