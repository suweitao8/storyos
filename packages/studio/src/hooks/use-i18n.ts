...
const strings = {
  ...
  "nav.createPlay": { zh: "StoryOS 互动", en: "StoryOS Play" },
  ...
  "craft.structure": { zh: "故事结构", en: "Story Structure" },
  "craft.sceneRhythm": { zh: "节奏与场景", en: "Pacing & Scenes" },
  "craft.infoDisclosure": { zh: "信息与悬念", en: "Information & Suspense" },
  "craft.narrativePOV": { zh: "视角与叙述", en: "Perspective & Voice" },
  ...
  "craft.openingPattern": { zh: "怎么开头", en: "How It Opens" },
  "craft.chapterArc": { zh: "一章怎么推进", en: "Chapter Flow" },
  "craft.endingHook": { zh: "章末怎么吊人", en: "Chapter Endings" },
  "craft.sceneTransition": { zh: "场景怎么切换", en: "Scene Transitions" },
  "craft.pacingCurve": { zh: "节奏快慢变化", en: "Pacing" },
  "craft.conflictEscalation": { zh: "麻烦怎么升级", en: "Rising Stakes" },
  "craft.foreshadowing": { zh: "埋了多少伏笔", en: "Foreshadowing" },
  "craft.infoRelease": { zh: "信息怎么透露", en: "Revealing Info" },
  "craft.suspense": { zh: "悬念怎么吊", en: "Building Suspense" },
  "craft.povStrategy": { zh: "用谁的视角", en: "Whose Eyes" },
  "craft.dialogueRatio": { zh: "对话和叙述比例", en: "Dialogue Balance" },
  "craft.narrativeDistance": { zh: "离角色多近", en: "Closeness" },
  ...
  "doctor.inkosJson": { zh: "storyos.json 配置", en: "storyos.json configuration" },
  "doctor.projectEnv": { zh: "项目环境文件", en: "Project environment file" },
  "doctor.globalEnv": { zh: "全局 ~/.storyos/.env", en: "Global ~/.storyos/.env" },
  ...
  "genre.styleHint": { zh: "画面风格描述，生成时会追加到图片模板末尾。留空则使用全局默认。", en: "Art style description appended to image templates at generation time. Leave empty to use global default." },
