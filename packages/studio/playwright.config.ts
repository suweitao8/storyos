...
export default defineConfig({
  ...
  // Always start a dedicated E2E server with STORYOS_AGENT_LLM_STUB=1 so the
  ...
  webServer: {
    command: "STORYOS_AGENT_LLM_STUB=1 STORYOS_STUDIO_PORT=4581 STORYOS_PROJECT_ROOT=../../test-project tsx watch --clear-screen=false src/api/index.ts & STORYOS_AGENT_LLM_STUB=1 STORYOS_STUDIO_PORT=4581 vite --host --port 4580 ; kill %1 2>/dev/null",
